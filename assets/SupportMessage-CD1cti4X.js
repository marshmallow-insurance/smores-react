import{a as p,j as o,s as i,A as g}from"./styled-components.browser.esm-CskBwHif.js";import{c as l}from"./polished.esm-D0h1-lPB.js";import{B as a}from"./Box-B8NHevNo.js";import{I as d}from"./Icon-BfAHxEoF.js";import{T as h}from"./Text-B9wfG2mn.js";import{t as e}from"./theme-D50qMPxU.js";import{i as y}from"./isReactElement-DALlT1kK.js";const t={info:{iconColor:"liquorice",backgroundColor:e.colors.custard,hoverBackgroundColor:l(.1,e.colors.custard),icon:"info"},fallbackStyle:{iconColor:"liquorice",backgroundColor:e.colors.coconut,hoverBackgroundColor:l(.1,e.colors.coconut),icon:"info"},alert:{iconColor:"tangerine",backgroundColor:e.colors.sherbert,hoverBackgroundColor:l(.1,e.colors.sherbert),icon:"alert"},warning:{iconColor:"strawberry",backgroundColor:e.colors.watermelon,hoverBackgroundColor:l(.1,e.colors.watermelon),icon:"warning"},success:{iconColor:"apple",backgroundColor:e.colors.mint,hoverBackgroundColor:l(.1,e.colors.mint),icon:"included"}},m=({className:n,description:r,onClick:s,type:c="info",title:u,...f})=>p(x,{className:n,type:c,onClick:s,...f,children:[o(v,{children:o(d,{size:20,render:t[c].icon,color:t[c].iconColor})}),p(a,{flex:!0,direction:"column",mx:"8px",children:[u&&o(C,{children:u}),y(r)?o(b,{children:r}):o(k,{tag:"p",children:r})]}),s&&o(a,{ml:{custom:"auto"},children:o(d,{size:16,render:"caret",color:"marzipan",rotate:270})})]}),v=i(a)`
