import{a as s,j as o,s as l,A as u}from"./styled-components.browser.esm-CskBwHif.js";import{r as A}from"./index-BBkUAzwr.js";import{B as a}from"./Box-Ck8x80mg.js";import{I as B}from"./Icon-GveiwEP7.js";import{t as c}from"./theme-D50qMPxU.js";import{T as y}from"./Text-BfQCQ9vW.js";import"./polished.esm-D0h1-lPB.js";import"./focusOutline-JAHtHrmh.js";const r=({title:e,children:t,onToggle:n,filledBackground:i,defaultIsOpen:d=!1,borderTop:h=!1,borderColor:k="oatmeal",backgroundColor:C="custard",subTitle:x,fullBorder:v=!1,...S})=>{const[m,T]=A.useState(d),_=v?"16px":"0";return s(I,{borderTop:h,fullBorder:v,filledBackground:i,borderColor:k,backgroundColor:C,...S,children:[s(L,{flex:!0,alignItems:"center",justifyContent:"space-between",onClick:()=>{const q=!m;n==null||n(q),T(q)},py:"16px",pr:"16px",pl:_,children:[s($,{children:[o(y,{tag:"h2",typo:"headline-regular",color:"liquorice",children:e}),x&&o(y,{tag:"label",color:"liquorice",typo:"label",mt:{custom:4},children:x})]}),o(O,{render:"caret",size:24,color:"marzipan",isOpen:m,borderTop:h})]}),m&&o(a,{pt:"12px",pb:"16px",px:_,children:t})]})},I=l(a)(({borderTop:e,fullBorder:t,filledBackground:n,borderColor:i="oatmeal",backgroundColor:d="custard"})=>u`
