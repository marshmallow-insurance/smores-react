import{j as o,s as i,A as f}from"./styled-components.browser.esm-CJMx1vp9.js";import{c as l}from"./polished.esm-D0h1-lPB.js";import{B as a}from"./Box-DB724hnb.js";import{I as p}from"./Icon-CtANFpqu.js";import{T as g}from"./Text-DnLt-YfN.js";import{t as e}from"./theme-D50qMPxU.js";import{i as x}from"./isReactElement-DALlT1kK.js";const t={info:{iconColor:"liquorice",backgroundColor:e.colors.custard,hoverBackgroundColor:l(.1,e.colors.custard),icon:"info"},fallbackStyle:{iconColor:"liquorice",backgroundColor:e.colors.coconut,hoverBackgroundColor:l(.1,e.colors.coconut),icon:"info"},alert:{iconColor:"tangerine",backgroundColor:e.colors.sherbert,hoverBackgroundColor:l(.1,e.colors.sherbert),icon:"alert"},warning:{iconColor:"strawberry",backgroundColor:e.colors.watermelon,hoverBackgroundColor:l(.1,e.colors.watermelon),icon:"warning"},success:{iconColor:"apple",backgroundColor:e.colors.mint,hoverBackgroundColor:l(.1,e.colors.mint),icon:"included"}},d=({className:n,description:r,onClick:c,type:s="info",title:u,...m})=>o.jsxs(y,{className:n,type:s,onClick:c,...m,children:[o.jsx(h,{children:o.jsx(p,{size:20,render:t[s].icon,color:t[s].iconColor})}),o.jsxs(a,{flex:!0,direction:"column",mx:"8px",children:[u&&o.jsx(v,{children:u}),x(r)?o.jsx(C,{children:r}):o.jsx(b,{tag:"p",children:r})]}),c&&o.jsx(a,{ml:{custom:"auto"},children:o.jsx(p,{size:16,render:"caret",color:"marzipan",rotate:270})})]}),h=i(a)`
