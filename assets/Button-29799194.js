import{j as h,a as i,s,A as n}from"./styled-components.browser.esm-1fe49baf.js";import{r as B}from"./index-1b03fe98.js";import{B as C}from"./Box-3f7820e1.js";import{I as S}from"./Icon-9ec719dc.js";import{L as w}from"./Loader-4d853a84.js";import{t as o}from"./theme-9a9bdd1b.js";import{f as N}from"./focusOutline-fc5530b3.js";const y=B.forwardRef((e,a)=>{const{children:d,id:u,className:c="",disabled:p=!1,handleClick:m,loading:r=!1,primary:x=!1,secondary:$=!1,fallbackStyle:v=!1,textBtn:g=!1,smallButton:f=!1,icon:l="",trailingIcon:t=!1,forcedWidth:V="",form:b,type:k,...P}=e;return h(R,{as:"button",id:u,className:c,disabled:p||r,onClick:m,$loading:r,primary:x,secondary:$,fallbackStyle:v,textBtn:g,smallButton:f,icon:l,trailingIcon:t,forcedWidth:V,...b?{form:b}:{},type:k,...P,ref:a,children:[r&&i(_,{children:i(w,{color:"liquorice",height:"16"})}),h(I,{icon:l,$loading:r,children:[!t&&l&&i(q,{trailingIcon:t,render:l,size:f?16:24,color:"liquorice"}),i(j,{className:"childrenContainer",children:d}),t&&l&&g&&i(q,{trailingIcon:t,render:l,size:f?16:24,color:"liquorice",className:"iconContainer"})]})]})});y.displayName="Button";const R=s(C)(({disabled:e,$loading:a,primary:d,secondary:u,forcedWidth:c,fallbackStyle:p,textBtn:m,smallButton:r})=>n`
    position: relative;
...
//# sourceMappingURL=Button-29799194.js.map
