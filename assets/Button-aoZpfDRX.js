import{a as b,j as i,u as t,b as u}from"./styled-components.browser.esm-NpdVBoMN.js";import{r as B}from"./index-BBkUAzwr.js";import{B as P}from"./Box-BLBwDpxh.js";import{I as C}from"./Icon-2S2VEaHH.js";import{L as S}from"./Loader-CuMh7kMB.js";import{t as a}from"./theme-D50qMPxU.js";import{a as I}from"./focusOutline-Ba1vYvXH.js";const f=B.forwardRef((e,l)=>{const{children:v,id:d,className:c="",disabled:s=!1,handleClick:p,loading:o=!1,primary:k=!1,secondary:w=!1,fallbackStyle:x=!1,textBtn:g=!1,smallButton:m=!1,icon:n,trailingIcon:r=!1,forcedWidth:$="",form:h,type:q,...V}=e;return b(N,{forwardedAs:"button",id:d,className:c,disabled:s||o,onClick:p,$loading:o,$primary:k,$secondary:w,$fallbackStyle:x,$textBtn:g,$smallButton:m,$trailingIcon:r,$forcedWidth:$,...h?{form:h}:{},type:q,...V,ref:l,children:[o&&i(R,{children:i(S,{color:"liquorice",height:"16"})}),b(_,{$icon:n,$loading:o,children:[!r&&n&&i(y,{$trailingIcon:r,render:n,size:m?16:24,color:"liquorice"}),i(j,{className:"childrenContainer",children:v}),r&&n&&g&&i(y,{$trailingIcon:r,render:n,size:m?16:24,color:"liquorice",className:"iconContainer"})]})]})});f.displayName="Button";const N=t(P)(({disabled:e,$loading:l,$primary:v,$secondary:d,$forcedWidth:c,$fallbackStyle:s,$textBtn:p,$smallButton:o})=>u`
    position: relative;
