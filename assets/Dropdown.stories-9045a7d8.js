import{j as e,a as h,A as L,s as g}from"./styled-components.browser.esm-eb1c464b.js";import{r as _}from"./index-1b03fe98.js";import{t as m}from"./theme-9a9bdd1b.js";import{I as X}from"./Icon-641c05f5.js";import{F as K}from"./Field-ef04d49a.js";import{u as Q}from"./id-f73e93ae.js";import{u as Z}from"./useControlledState-cd167c1b.js";import{B as b}from"./Box-f9b8808b.js";import{S as M}from"./CommonInput-4ddf4046.js";import{T as O}from"./Text-39468910.js";import{n as ee}from"./noop-1bad6ac0.js";import"./InternalField-b01bd094.js";import"./polished.esm-bca90884.js";import"./focusOutline-54f19c39.js";const l=_.forwardRef(function({id:r,placeholder:i,showDefaultOption:t=!1,customDefaultOption:n,name:o,value:U,defaultValue:z,disabled:w=!1,list:v,onSelect:x,error:T=!1,onInputChange:D,onBlur:G,frontIcon:q,fallbackStyle:H,...W},B){const[A,j]=Z({initialState:z,stateProp:U}),P=Q(r),E=v.findIndex(d=>!!d.optionGroupLabel)!==-1,J=_.useMemo(()=>{const d=new Map;return v.forEach(u=>{const p=u.optionGroupLabel??"",c=d.get(p)??[];c.push(u),d.set(p,c)}),Array.from(d.values())},[v]),S=()=>t?n??"Select an option":i;return e(K,{...W,htmlFor:P,error:T,children:h(b,{flex:!0,alignItems:"center",children:[q&&e(M,{disabled:w,render:q,color:"sesame"}),h(re,{id:P,disabled:w||v.length<1,onChange:d=>{const u=d.currentTarget.value;x==null||x(u),D==null||D(d),j(u)},error:T,ref:B,onBlur:G,name:o,frontIcon:q,fallbackStyle:H,value:A||"",children:[E?e("optgroup",{label:S(),children:e("option",{value:"",hidden:!t,disabled:!0,children:S()})}):e("option",{value:"",hidden:!t,disabled:!0,children:S()}),J.map((d,u)=>E?e("optgroup",{label:d[0].optionGroupLabel??"Other",children:d.map((p,c)=>e("option",{value:p.value,children:p.label},`${u}-${c}`))},u):d.map((p,c)=>e("option",{value:p.value,children:p.label},c)))]}),e(le,{children:e(X,{render:"caret",color:"marzipan",size:24})})]})})}),ae=L`
  border: none;
  border-radius: 0;
  font-size: 16px;
