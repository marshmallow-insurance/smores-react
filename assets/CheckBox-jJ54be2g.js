import{r as u,R as e}from"./index-BBkUAzwr.js";import{u as s}from"./styled-components.browser.esm-uaFiJyE8.js";import{f as x}from"./focusOutline-DynQQMjx.js";import{T as b}from"./Text-DW1uYbgU.js";import{t as o}from"./theme-D50qMPxU.js";import{u as f}from"./id-CqcUMuGv.js";const g=u.forwardRef(function({id:c,checked:n,children:l,toggle:p,error:t,errorMsg:i},d){const m=f(c);return e.createElement(e.Fragment,null,e.createElement(h,{id:m},e.createElement(b,{tag:"span",typo:"base",color:t?"strawberry":"liquorice"},l),e.createElement("input",{ref:d,type:"checkbox",checked:n,onChange:p}),e.createElement(r,{$error:t})),t&&i&&e.createElement(k,null,i))}),r=s.span`
  position: absolute;
  left: 0;
  width: 24px;
  height: 24px;
