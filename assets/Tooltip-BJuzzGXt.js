import{r as i,R as f}from"./index-BBkUAzwr.js";import{r as X}from"./index-PqR-_bA4.js";import{u as T,a as r}from"./styled-components.browser.esm-uaFiJyE8.js";import{B as j}from"./Box-BsRHaABa.js";import{T as k}from"./Text-DW1uYbgU.js";import"./bodyScrollLock.esm-DhkVtT7o.js";import{t as h}from"./theme-D50qMPxU.js";const q=({eventName:e,callback:l,ref:o,capture:s=!1})=>{i.useEffect(()=>{const p=o&&o.current;if(!p)return;const w={capture:s};return p.addEventListener(e,l,w),()=>{p.removeEventListener(e,l,w)}},[e,o,l,s])},P=(e,l)=>{let o;return(...s)=>{o&&clearTimeout(o),o=setTimeout(()=>{e(...s),o=void 0},l)}},H=({children:e,title:l,content:o,position:s="top",maxWidth:p=500,underline:w=!1,fallbackStyle:$=!1,zIndex:I=10,portalContainer:S=document.body})=>{const v=i.useRef(document),c=i.useRef(null),[z,E]=i.useState(!1),[g,u]=i.useState(s),[n,D]=i.useState(null),[C,N]=i.useState({top:0,left:0}),R=crypto.randomUUID(),Y=t=>t.top>=0&&t.left>=0&&t.bottom<=window.innerHeight&&t.right<=window.innerWidth,y=i.useCallback(()=>{var a;const t=(a=c.current)==null?void 0:a.getBoundingClientRect();if(t&&!Y(t)){if(t.top>=0&&g!=="top"){u("top");return}if(t.top<0){u("bottom");return}if(t.right>window.innerWidth){u("left");return}if(t.left<0){u("right");return}if(t.bottom>window.innerHeight){u("top");return}}},[c,g]);i.useEffect(()=>{y(),D(document.getElementById(R))},[]),i.useEffect(()=>{u(s)},[s]);const b=18,L=()=>{if(!n)return{top:0,left:0};if(!c.current)return{top:0,left:0};const t=n.getBoundingClientRect(),a=c.current.getBoundingClientRect();let d=0,m=0;switch(g){case"top":d=t.top+window.scrollY-a.height-b,m=t.left+window.scrollX+t.width/2-a.width/2;break;case"bottom":d=t.bottom+window.scrollY+b,m=t.left+window.scrollX+t.width/2-a.width/2;break;case"left":m=t.left+window.scrollX-a.width-b,d=t.top+window.scrollY+t.height/2-a.height/2;break;case"right":m=t.right+window.scrollX+b,d=t.top+window.scrollY+t.height/2-a.height/2;break}return{top:d,left:m}};return i.useEffect(()=>{n&&N(L())},[s,window.scrollY,c.current,n,n==null?void 0:n.getBoundingClientRect().top,n==null?void 0:n.getBoundingClientRect().left]),q({eventName:"resize",callback:P(y,100),ref:v}),q({eventName:"scroll",callback:P(y,100),ref:v}),f.createElement(U,null,f.createElement(W,{id:R,$underline:w,onMouseEnter:()=>E(!0),onMouseLeave:()=>E(!1)},e),n&&X.createPortal(f.createElement(J,{className:"tooltip",$showTip:z,$position:s,$arrowPosition:g,ref:c,$maxWidth:p,$fallbackStyle:$,$zIndex:I,style:{position:"absolute",top:`${C.top}px`,left:`${C.left}px`}},l&&f.createElement(k,{tag:"h5",typo:"desc-medium",color:$?"cream":"liquorice"},l),typeof o=="string"&&f.createElement(k,{typo:"desc-light",color:$?"cream":"liquorice"},o)||o),S))},U=T.div`
  display: flex;
  align-items: center;
