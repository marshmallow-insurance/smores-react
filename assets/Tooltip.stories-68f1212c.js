import{j as V,a as o,s as Y,A as t,F as ee}from"./styled-components.browser.esm-1fe49baf.js";import{B as S}from"./Box-0e300cd1.js";import{T as n}from"./Text-81caf24d.js";import{r}from"./index-1b03fe98.js";import{t as E}from"./theme-9a9bdd1b.js";import"./polished.esm-b6220ab2.js";import"./focusOutline-65f7e9f7.js";import"./Icon-758c1c6b.js";const k=({eventName:e,callback:p,ref:i,capture:b=!1})=>{r.useEffect(()=>{const c=i&&i.current;if(!c)return;const d={capture:b};return c.addEventListener(e,p,d),()=>{c.removeEventListener(e,p,d)}},[e,i,p,b])},T=({children:e,title:p,content:i,maxWidth:b=500,underline:c=!1,defaultArrowPosition:d="center"})=>{const _=r.useRef(null),L=r.useRef(document),[U,C]=r.useState(!1),[a,m]=r.useState("top"),[u,f]=r.useState(d),Z=l=>l.top>=0&&l.left>=0&&l.bottom<=window.innerHeight&&l.right<=window.innerWidth,P=r.useCallback(()=>{var R;const l=a==="left"||a==="right",N=a==="top"||a==="bottom",v=()=>{u==="left"&&f("top"),u==="right"&&f("bottom"),u==="top"&&f("left"),u==="bottom"&&f("right")},s=(R=_.current)==null?void 0:R.getBoundingClientRect();if(s&&!Z(s)){if(s.top>=0&&a!=="top"){f(d),m("top");return}if(s.top<0){l&&v(),m("bottom");return}if(s.right>window.innerWidth){N&&v(),m("left");return}if(s.left<0){N&&v(),m("right");return}if(s.bottom>window.innerHeight){l&&v(),m("top");return}}},[_,a,u]);return r.useEffect(()=>{P()},[]),k({eventName:"resize",callback:P,ref:L}),k({eventName:"scroll",callback:P,ref:L}),V(H,{underline:c,children:[o(n,{cursor:"pointer",onMouseEnter:()=>C(!0),onMouseLeave:()=>C(!1),children:e}),V(B,{className:"tooltip",showTip:U,position:a,arrowPosition:u,ref:_,maxWidth:b,children:[p&&o(n,{tag:"h5",typo:"desc-medium",color:"liquorice",children:p}),typeof i=="string"&&o(n,{typo:"desc-light",color:"liquorice",children:i})||i]})]})},H=Y.div`
  position: relative;
  display: flex;
  align-items: center;
...
//# sourceMappingURL=Tooltip.stories-68f1212c.js.map
