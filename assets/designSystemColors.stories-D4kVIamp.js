import{i as e}from"./preload-helper-BdFrVu1K.js";import{t}from"./jsx-runtime-f3rHp9ZU.js";import{c as n,o as r,s as i}from"./iframe-B9Lmr4Di.js";import{n as a,t as o}from"./Box-DeJHtS5u.js";import{a as s,r as c}from"./colourMap-D6toVtFS.js";import{t as l}from"./Text-CH6ALylz.js";import{t as u}from"./Text-BDKCJt6y.js";import{n as d,t as f}from"./colourOptions-DNLA4x_8.js";import{t as p}from"./Divider-C7PqlSB9.js";import{t as m}from"./Divider-BZPj5qTq.js";var h,g,_,v,y,b,x,S,C,w,T,E,D;e((()=>{i(),d(),o(),m(),u(),c(),h=t(),g=()=>{let e=[],t=e=>e.startsWith(`color`)?e.split(`.`).slice(0,2).join(`.`):e.split(`.`).slice(0,1).join(`.`);return new Set(f.map(e=>t(e))).forEach(t=>{let n=t.split(`.`).slice(0).join(` `).replace(/\b\w/g,e=>e.toUpperCase()),r=f.filter(e=>e.startsWith(t));e.push({title:n,colors:r})}),e},_=({colorName:e})=>{let t=s(e,n());return(0,h.jsxs)(T,{width:`260px`,children:[(0,h.jsx)(E,{$colorName:e,width:`100%`,pt:{custom:`50%`}}),(0,h.jsx)(p,{}),(0,h.jsxs)(a,{px:`space.200`,py:`space.050`,flex:!0,direction:`column`,children:[(0,h.jsx)(l,{tag:`span`,typo:`body-regular`,children:e}),(0,h.jsx)(l,{tag:`span`,typo:`caption`,color:`sesame`,children:t.toUpperCase()})]})]})},v=({title:e,colors:t})=>(0,h.jsxs)(a,{width:`100%`,children:[(0,h.jsx)(a,{mb:`space.200`,children:(0,h.jsx)(l,{tag:`span`,typo:`headline-small`,children:e})}),(0,h.jsx)(C,{children:t.map(e=>(0,h.jsx)(_,{colorName:e},e))})]}),y=()=>(0,h.jsx)(w,{children:g().map(e=>(0,h.jsx)(v,{title:e.title,colors:e.colors},e.title))}),b={title:`Foundation/Design System Colors`,components:y},x=()=>(0,h.jsx)(y,{}),S=x.bind({}),C=r(a)`
  display: flex;
  flex-wrap: wrap;
  flex-direction: row;
...
//# sourceMappingURL=designSystemColors.stories-D4kVIamp.js.map