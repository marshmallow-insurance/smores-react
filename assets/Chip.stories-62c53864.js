import{a as i,j as A,F as L,s as _,A as y}from"./styled-components.browser.esm-1fe49baf.js";import{r as j}from"./index-1b03fe98.js";import{t as e}from"./theme-9a9bdd1b.js";import{B as E}from"./Box-3f7820e1.js";import{I as B}from"./Icon-9ec719dc.js";import{L as F}from"./Loader-4d853a84.js";import{a as I}from"./focusOutline-fc5530b3.js";const c=j.forwardRef(({children:a,handleClick:m,primary:s=!1,secondary:o=!1,disabled:r=!1,loading:u=!1,icon:f="",...R},w)=>i(N,{as:"button",primary:s,secondary:o,disabled:r||u,$loading:u,onClick:m,icon:f,...R,ref:w,children:u?i(F,{color:s?"liquorice":"cream",height:"16"}):A(L,{children:[f&&i(B,{render:f,size:20,color:s?"liquorice":"cream"}),i(T,{children:a})]})}));c.displayName="Chip";const N=_(E)(({primary:a,secondary:m,icon:s,$loading:o,disabled:r})=>y`
    ${I()}
...
//# sourceMappingURL=Chip.stories-62c53864.js.map
