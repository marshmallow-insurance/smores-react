import{j as h,a as i,s,A as n}from"./styled-components.browser.esm-1fe49baf.js";import{r as B}from"./index-1b03fe98.js";import{B as C}from"./Box-64a8d8ff.js";import{I as S}from"./Icon-17e04ef2.js";import{L as w}from"./Loader-4d853a84.js";import{t as o}from"./theme-9a9bdd1b.js";import{f as N}from"./focusOutline-fc5530b3.js";const y=B.forwardRef((e,a)=>{const{children:d,id:u,className:c="",disabled:p=!1,handleClick:m,loading:l=!1,primary:x=!1,secondary:$=!1,fallbackStyle:v=!1,textBtn:g=!1,smallButton:f=!1,icon:r="",trailingIcon:t=!1,forcedWidth:V="",form:b,type:k,...P}=e;return h(R,{as:"button",id:u,className:c,disabled:p,onClick:m,$loading:l,primary:x,secondary:$,fallbackStyle:v,textBtn:g,smallButton:f,icon:r,trailingIcon:t,forcedWidth:V,...b?{form:b}:{},type:k,...P,ref:a,children:[l&&i(_,{children:i(w,{color:"liquorice",height:"16"})}),h(I,{icon:r,$loading:l,children:[!t&&r&&i(q,{trailingIcon:t,render:r,size:f?16:24,color:"liquorice"}),i(j,{className:"childrenContainer",children:d}),t&&r&&g&&i(q,{trailingIcon:t,render:r,size:f?16:24,color:"liquorice",className:"iconContainer"})]})]})});y.displayName="Button";const R=s(C)(({disabled:e,$loading:a,primary:d,secondary:u,forcedWidth:c,fallbackStyle:p,textBtn:m,smallButton:l})=>n`
    position: relative;
...
//# sourceMappingURL=Button-1fa8a22b.js.map
