...
`);A().s[4]++;u.__docgenInfo={description:"",methods:[],displayName:"SliderInput"};const U={title:"SliderInput",component:u,args:{onChange:M()}},s={args:{min:1,max:10,mt:"64px","aria-label":"slider"}};var l,m,d;s.parameters={...s.parameters,docs:{...(l=s.parameters)==null?void 0:l.docs,source:{originalSource:`{
  args: {
    min: 1,
    max: 10,
    mt: '64px',
...
}`,...(d=(m=s.parameters)==null?void 0:m.docs)==null?void 0:d.source}}};const L=["Default"];export{s as Default,L as __namedExportsOrder,U as default};
//# sourceMappingURL=SliderInput.stories-COXcPKuN.js.map
