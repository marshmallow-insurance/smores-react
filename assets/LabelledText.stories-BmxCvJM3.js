...
| { custom: number | string }`,elements:[{name:`literal`,value:`'0'`},{name:`union`,raw:`'8px' | '12px' | '16px' | '24px' | '32px' | '48px' | '64px'`,elements:[{name:`literal`,value:`'8px'`},{name:`literal`,value:`'12px'`},{name:`literal`,value:`'16px'`},{name:`literal`,value:`'24px'`},{name:`literal`,value:`'32px'`},{name:`literal`,value:`'48px'`},{name:`literal`,value:`'64px'`}]},{name:`intersection`,raw:`{
  ...
  [K in keyof T]: T[K]
}`,signature:{properties:[{key:{name:`unknown`,required:!0},value:{name:`unknown[K]`,raw:`T[K]`}}]}},{name:`signature`,type:`object`,raw:`{}`,signature:{properties:[]}}]},{name:`signature`,type:`object`,raw:`{ custom: number | string }`,signature:{properties:[{key:`custom`,value:{name:`union`,raw:`number | string`,elements:[{name:`number`},{name:`string`}],required:!0}}]}}]}],raw:`Record<Breakpoint, PropValue>`}],raw:`Partial<Record<Breakpoint, PropValue>>`}]},description:``}}}})),p,m,h,g;e((()=>{f(),p=r(),m={title:`LabelledText`,component:u,decorators:[e=>(0,p.jsx)(`div`,{style:{margin:`64px`},children:(0,p.jsx)(e,{})})]},h={args:{label:`Name`},render:e=>(0,p.jsx)(u,{...e,children:`Hideo Kojima`})},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  args: {
    label: 'Name'
  },
...
//# sourceMappingURL=LabelledText.stories-BmxCvJM3.js.map