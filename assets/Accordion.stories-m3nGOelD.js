import{a as s,j as o,u as l,b as u}from"./styled-components.browser.esm-NpdVBoMN.js";import{r as B}from"./index-BBkUAzwr.js";import{B as a}from"./Box-BLBwDpxh.js";import{I as S}from"./Icon-DLXA4yL5.js";import{T as g}from"./Text-BGEp9_7I.js";import{t as c}from"./theme-D50qMPxU.js";import"./polished.esm-D0h1-lPB.js";import"./focusOutline-Ba1vYvXH.js";const t=({title:e,children:r,onToggle:n,filledBackground:i,defaultIsOpen:d=!1,borderTop:h=!1,borderColor:w="oatmeal",backgroundColor:C="custard",subTitle:x,fullBorder:v=!1,...$})=>{const[m,T]=B.useState(d),_=v?"16px":"0";return s(I,{$borderTop:h,$fullBorder:v,$filledBackground:i,$borderColor:w,$backgroundColor:C,...$,children:[s(O,{flex:!0,alignItems:"center",justifyContent:"space-between",onClick:()=>{const q=!m;n==null||n(q),T(q)},py:"16px",pr:"16px",pl:_,children:[s(A,{children:[o(g,{tag:"h2",typo:"headline-regular",color:"liquorice",children:e}),x&&o(g,{tag:"label",color:"liquorice",typo:"label",mt:{custom:4},children:x})]}),o(L,{render:"caret",size:24,color:"marzipan",$isOpen:m,$borderTop:h})]}),m&&o(a,{pt:"12px",pb:"16px",px:_,children:r})]})},I=l(a)(({$borderTop:e,$fullBorder:r,$filledBackground:n,$borderColor:i="oatmeal",$backgroundColor:d="custard"})=>u`
