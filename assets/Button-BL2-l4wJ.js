import{a as b,j as i,s as t,A as u}from"./styled-components.browser.esm-CskBwHif.js";import{r as P}from"./index-BBkUAzwr.js";import{B}from"./Box-C7hh6OC3.js";import{I as C}from"./Icon-BYvmBiBo.js";import{L as S}from"./Loader-BwvOIFW8.js";import{t as a}from"./theme-D50qMPxU.js";import{a as N}from"./focusOutline-JAHtHrmh.js";const f=P.forwardRef((e,l)=>{const{children:v,id:s,className:c="",disabled:d=!1,handleClick:p,loading:o=!1,primary:k=!1,secondary:w=!1,fallbackStyle:x=!1,textBtn:g=!1,smallButton:m=!1,icon:n,trailingIcon:r=!1,forcedWidth:q="",form:h,type:$,...V}=e;return b(R,{as:"button",id:s,className:c,disabled:d||o,onClick:p,$loading:o,primary:k,secondary:w,fallbackStyle:x,textBtn:g,smallButton:m,icon:n,trailingIcon:r,forcedWidth:q,...h?{form:h}:{},type:$,...V,ref:l,children:[o&&i(_,{children:i(S,{color:"liquorice",height:"16"})}),b(j,{icon:n,$loading:o,children:[!r&&n&&i(y,{trailingIcon:r,render:n,size:m?16:24,color:"liquorice"}),i(I,{className:"childrenContainer",children:v}),r&&n&&g&&i(y,{trailingIcon:r,render:n,size:m?16:24,color:"liquorice",className:"iconContainer"})]})]})});f.displayName="Button";const R=t(B)(({disabled:e,$loading:l,primary:v,secondary:s,forcedWidth:c,fallbackStyle:d,textBtn:p,smallButton:o})=>u`
    position: relative;
