import{a as e,j as g,A as B,s as h}from"./styled-components.browser.esm-1fe49baf.js";import{r as E}from"./index-1b03fe98.js";import{t as c}from"./theme-9a9bdd1b.js";import{I as O}from"./Icon-16aa76aa.js";import{F as j}from"./Field-f64c3c0f.js";import{u as M}from"./id-f73e93ae.js";import{u as J}from"./useControlledState-cd167c1b.js";import{B as b}from"./Box-8725b8d8.js";import{S as X}from"./CommonInput-ce5b3a1a.js";import{T as N}from"./Text-77fda0c7.js";import{n as K}from"./noop-1bad6ac0.js";import"./InternalField-93bfb99d.js";import"./polished.esm-b6220ab2.js";import"./focusOutline-fc5530b3.js";const t=E.forwardRef(function({id:r,placeholder:l,name:n,value:o,defaultValue:i,disabled:V=!1,list:v,onSelect:x,error:T=!1,onInputChange:D,onBlur:C,frontIcon:S,fallbackStyle:U,...z},G){const[w,H]=J({initialState:i,stateProp:o}),A=M(r),P=v.findIndex(s=>!!s.optionGroupLabel)!==-1,W=E.useMemo(()=>{const s=new Map;return v.forEach(u=>{const p=u.optionGroupLabel??"",m=s.get(p)??[];m.push(u),s.set(p,m)}),Array.from(s.values())},[v]);return e(j,{...z,htmlFor:A,error:T,children:g(b,{flex:!0,alignItems:"center",children:[S&&e(X,{disabled:V,render:S,color:"sesame"}),g(Z,{id:A,disabled:V||v.length<1,onChange:s=>{const u=s.currentTarget.value;x==null||x(u),D==null||D(s),H(u)},error:T,ref:G,onBlur:C,name:n,frontIcon:S,fallbackStyle:U,value:w||"",children:[P?e("optgroup",{label:l,children:e("option",{value:"",hidden:!0,children:l})}):e("option",{value:"",hidden:!0,children:l}),W.map((s,u)=>P?e("optgroup",{label:s[0].optionGroupLabel??"Other",children:s.map((p,m)=>e("option",{value:p.value,children:p.label},`${u}-${m}`))},u):s.map((p,m)=>e("option",{value:p.value,children:p.label},m)))]}),e(ee,{children:e(O,{render:"caret",color:"marzipan",size:24})})]})})}),Q=B`
  border: none;
  border-radius: 0;
  font-size: 16px;
