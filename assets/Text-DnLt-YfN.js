import{j as u,s as v,A as a}from"./styled-components.browser.esm-CJMx1vp9.js";import{r as $}from"./index-BBkUAzwr.js";import{t as e}from"./theme-D50qMPxU.js";import{c}from"./polished.esm-D0h1-lPB.js";import{I as g}from"./Icon-CtANFpqu.js";import{f as z}from"./focusOutline-D9_3RTEn.js";import{B as b}from"./Box-DB724hnb.js";const x=({className:i,href:n,onClick:o,openInNewTab:t,download:m,children:d,typo:r="regular",highlight:p=!1,iconToRender:l=t?"new-window":void 0,isTrailingIcon:s=!0})=>u.jsxs(w,{href:n,className:i,onClick:o,download:m,typo:r,highlight:p,...t&&{rel:"noopener noreferrer",target:"_blank"},children:[l&&!s&&u.jsx(g,{mt:{custom:"3px"},mr:{custom:"4px"},render:l,size:r==="regular"?14:12,color:p?"lollipop":"liquorice"}),d,l&&s&&u.jsx(g,{mt:{custom:"3px"},ml:{custom:"4px"},render:l,size:r==="regular"?14:12,color:p?"lollipop":"liquorice"})]}),w=v.a(({typo:i,highlight:n})=>a`
    ${z()}
    display: inline-flex;
    flex-direction: row;
