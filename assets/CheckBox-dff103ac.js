import{a as n,F as x,j as r,s as i}from"./styled-components.browser.esm-eb1c464b.js";import{r as b}from"./index-1b03fe98.js";import{f as g}from"./focusOutline-54f19c39.js";import{T as h}from"./Text-4917767b.js";import{t as e}from"./theme-9a9bdd1b.js";import{u as k}from"./id-f73e93ae.js";const l=b.forwardRef(function({id:c,checked:d,children:p,toggle:u,error:a,errorMsg:s},m){const f=k(c);return n(x,{children:[n(y,{id:f,children:[r(h,{tag:"span",typo:"base",color:a?"strawberry":"liquorice",children:p}),r("input",{ref:m,type:"checkbox",checked:d,onChange:u}),r(o,{error:a})]}),a&&s&&r($,{children:s})]})}),o=i.span`
  position: absolute;
  left: 0;
  width: 24px;
  height: 24px;
