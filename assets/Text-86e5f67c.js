import{j as $,a as d,s as v,A as a}from"./styled-components.browser.esm-1fe49baf.js";import{r as z}from"./index-1b03fe98.js";import{t as e}from"./theme-9a9bdd1b.js";import{c}from"./polished.esm-b6220ab2.js";import{a as b}from"./focusOutline-fc5530b3.js";import{I as g}from"./Icon-17e04ef2.js";import{B as q}from"./Box-64a8d8ff.js";const x=({className:i,href:n,onClick:o,openInNewTab:t,download:u,children:m,typo:r="regular",highlight:p=!1,iconToRender:l=t?"new-window":"",isTrailingIcon:s=!0})=>$(w,{href:n,className:i,onClick:o,download:u,typo:r,highlight:p,...t&&{rel:"noopener noreferrer",target:"_blank"},children:[l&&!s&&d(g,{mt:{custom:"3px"},mr:{custom:"4px"},render:l,size:r==="regular"?14:12,color:p?"lollipop":"liquorice"}),m,l&&s&&d(g,{mt:{custom:"3px"},ml:{custom:"4px"},render:l,size:r==="regular"?14:12,color:p?"lollipop":"liquorice"})]}),w=v.a(({typo:i,highlight:n})=>a`
      ${b()}
      display: inline-flex;
      flex-direction: row;
...
`;try{x.displayName="Link",x.__docgenInfo={description:"",displayName:"Link",props:{className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},href:{defaultValue:null,description:"",name:"href",required:!0,type:{name:"string"}},onClick:{defaultValue:null,description:"",name:"onClick",required:!1,type:{name:"MouseEventHandler"}},openInNewTab:{defaultValue:null,description:"",name:"openInNewTab",required:!1,type:{name:"boolean"}},download:{defaultValue:null,description:"",name:"download",required:!1,type:{name:"boolean"}},typo:{defaultValue:{value:"regular"},description:"",name:"typo",required:!1,type:{name:"enum",value:[{value:'"small"'},{value:'"regular"'}]}},highlight:{defaultValue:{value:"false"},description:"",name:"highlight",required:!1,type:{name:"boolean"}},iconToRender:{defaultValue:{value:"openInNewTab ? 'new-window' : ''"},description:"",name:"iconToRender",required:!1,type:{name:"string"}},isTrailingIcon:{defaultValue:{value:"true"},description:"",name:"isTrailingIcon",required:!1,type:{name:"boolean"}}}}}catch{}try{h.displayName="linkStyleOverride",h.__docgenInfo={description:"Internal utility to override styling in other components (see Text)",displayName:"linkStyleOverride",props:{color:{defaultValue:null,description:"",name:"color",required:!0,type:{name:"string"}}}}}catch{}const y={"hero-alternate":`
  ...
  `},f=z.forwardRef(({children:i,typo:n="body-regular",className:o="",tag:t="p",align:u="left",color:m="liquorice",cursor:r="inherit",title:p="",...l},s)=>d(V,{as:t,className:o,typo:n,align:u,color:m,cursor:r,title:p,...l,ref:s,children:i}));f.displayName="Text";const _=i=>Object.keys(y).includes(i),V=v(q)(({align:i,color:n,cursor:o,typo:t})=>a`
    /** TYPOGRAPHY STYLES */
