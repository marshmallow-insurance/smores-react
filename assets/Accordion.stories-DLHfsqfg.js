import{j as e,s as l,A as p}from"./styled-components.browser.esm-CJMx1vp9.js";import{r as A}from"./index-BBkUAzwr.js";import{B as a}from"./Box-DB724hnb.js";import{I as B}from"./Icon-CtANFpqu.js";import{t as s}from"./theme-D50qMPxU.js";import{T as b}from"./Text-DnLt-YfN.js";import"./polished.esm-D0h1-lPB.js";import"./focusOutline-D9_3RTEn.js";const r=({title:o,children:t,onToggle:n,filledBackground:i,defaultIsOpen:u=!1,borderTop:y=!1,borderColor:V="oatmeal",backgroundColor:w="custard",subTitle:g,fullBorder:h=!1,...k})=>{const[d,C]=A.useState(u),v=h?"16px":"0",S=()=>{const j=!d;n==null||n(j),C(j)};return e.jsxs(T,{borderTop:y,fullBorder:h,filledBackground:i,borderColor:V,backgroundColor:w,...k,children:[e.jsxs($,{flex:!0,alignItems:"center",justifyContent:"space-between",onClick:S,py:"16px",pr:"16px",pl:v,children:[e.jsxs(I,{children:[e.jsx(b,{tag:"h2",typo:"headline-regular",color:"liquorice",children:o}),g&&e.jsx(b,{tag:"label",color:"liquorice",typo:"label",mt:{custom:4},children:g})]}),e.jsx(R,{render:"caret",size:24,color:"marzipan",isOpen:d,borderTop:y})]}),d&&e.jsx(a,{pt:"12px",pb:"16px",px:v,children:t})]})},T=l(a)(({borderTop:o,fullBorder:t,filledBackground:n,borderColor:i="oatmeal",backgroundColor:u="custard"})=>p`
