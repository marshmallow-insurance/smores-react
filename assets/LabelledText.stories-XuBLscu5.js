import{j as a,d as s}from"./iframe-Cqp6oSul.js";import{B as c}from"./index-BqrVJh6M.js";import"./index-BKQ4Zz35.js";import{T as x}from"./Text-CuRVajKM.js";import"./preload-helper-PPVm8Dsz.js";import"./space-qkSJaf43.js";import"./getFromObject-CS2Xcxjx.js";import"./polished.esm-CYsXSD1d.js";import"./index-BSdddFjE.js";import"./colourMap-D9bY40O0.js";import"./focusOutline-DgFhqWyx.js";import"./shared.styles-DqaJbK5E.js";function n(){var e="/home/runner/work/smores-react/smores-react/src/LabelledText/LabelledText.tsx",m="02e8d937b62c423f94bb3dc6f32c3120a1886cab",r=globalThis,t="__coverage__",o={path:"/home/runner/work/smores-react/smores-react/src/LabelledText/LabelledText.tsx",statementMap:{0:{start:{line:5,column:28},end:{line:13,column:4}},1:{start:{line:10,column:22},end:{line:13,column:4}},2:{start:{line:14,column:18},end:{line:21,column:1}},3:{start:{line:19,column:43},end:{line:19,column:55}},4:{start:{line:22,column:0},end:{line:22,column:20182}}},fnMap:{0:{name:"(anonymous_0)",decl:{start:{line:5,column:28},end:{line:5,column:29}},loc:{start:{line:10,column:22},end:{line:13,column:4}},line:10},1:{name:"(anonymous_1)",decl:{start:{line:19,column:21},end:{line:19,column:22}},loc:{start:{line:19,column:43},end:{line:19,column:55}},line:19}},branchMap:{0:{loc:{start:{line:8,column:2},end:{line:8,column:17}},type:"default-arg",locations:[{start:{line:8,column:16},end:{line:8,column:17}}],line:8}},s:{0:0,1:0,2:0,3:0,4:0},f:{0:0,1:0},b:{0:[0]},inputSourceMap:{version:3,file:null,sources:["/home/runner/work/smores-react/smores-react/src/LabelledText/LabelledText.tsx"],names:[],mappings:"AAmBE,SACE,KADF;AAlBF,OAAO,YAAY;AAGnB,SAAS,WAAW;AACpB,SAAS,YAAY;AAQd,aAAM,eAAsC,CAAC;AAAA,EAClD;AAAA,EACA;AAAA,EACA,cAAc;AAAA,EACd,GAAG;AACL,MACE,qBAAC,aAAW,GAAG,aAAa,cAAc,cAAc,MACtD;AAAA,sBAAC,QAAK,KAAI,SAAQ,OAAM,UAAS,MAAK,SACnC,iBACH;AAAA,EACC;AAAA,GACH;AAGF,MAAM,YAAY,OAAO,GAAG;AAAA;AAAA;AAAA;AAAA;AAAA,qBAKP,CAAC,EAAE,aAAa,MAAM,YAAY;AAAA;AAAA;;"},_coverageSchema:"1a1c01bbd47fc00a2c39e90264f33305004495a9",hash:"02e8d937b62c423f94bb3dc6f32c3120a1886cab"},l=r[t]||(r[t]={});(!l[e]||l[e].hash!==m)&&(l[e]=o);var p=l[e];return n=function(){return p},p}n();n().s[0]++;const u=({label:e,children:m,labelMargin:r=(n().b[0][0]++,4),...t})=>(n().f[0]++,n().s[1]++,a.jsxs(g,{...t,$labelMargin:r+"px",children:[a.jsx(x,{tag:"label",color:"sesame",typo:"label",children:e}),m]})),g=(n().s[2]++,s(c)`
  display: flex;
  flex-direction: column;

  label {
    margin-bottom: ${({$labelMargin:e})=>(n().f[1]++,n().s[3]++,e)};
  }
`);n().s[4]++;u.__docgenInfo={description:"",methods:[],displayName:"LabelledText",props:{children:{required:!0,tsType:{name:"ReactNode"},description:""},label:{required:!0,tsType:{name:"union",raw:"string | JSX.Element",elements:[{name:"string"},{name:"JSX.Element"}]},description:""},labelMargin:{required:!1,tsType:{name:"union",raw:"2 | 4 | 8 | number",elements:[{name:"literal",value:"2"},{name:"literal",value:"4"},{name:"literal",value:"8"},{name:"number"}]},description:"",defaultValue:{value:"4",computed:!1}},m:{required:!1,tsType:{name:"union",raw:"PropValue | PropByBreakpoint<PropValue>",elements:[{name:"union",raw:`| '0'
| LegacySpacing
| ThemeSpacing
...
| { custom: number | string }`,elements:[{name:"literal",value:"'0'"},{name:"union",raw:"'8px' | '12px' | '16px' | '24px' | '32px' | '48px' | '64px'",elements:[{name:"literal",value:"'8px'"},{name:"literal",value:"'12px'"},{name:"literal",value:"'16px'"},{name:"literal",value:"'24px'"},{name:"literal",value:"'32px'"},{name:"literal",value:"'48px'"},{name:"literal",value:"'64px'"}]},{name:"intersection",raw:`{
  ...
  [K in keyof T]: T[K]
}`,signature:{properties:[{key:{name:"unknown",required:!0},value:{name:"unknown[K]",raw:"T[K]"}}]}},{name:"signature",type:"object",raw:"{}",signature:{properties:[]}}]},{name:"signature",type:"object",raw:"{ custom: number | string }",signature:{properties:[{key:"custom",value:{name:"union",raw:"number | string",elements:[{name:"number"},{name:"string"}],required:!0}}]}}]}],raw:"Record<Breakpoint, PropValue>"}],raw:"Partial<Record<Breakpoint, PropValue>>"}]},description:""}}};const S={title:"LabelledText",component:u,decorators:[e=>a.jsx("div",{style:{margin:"64px"},children:a.jsx(e,{})})]},i={args:{label:"Name"},render:e=>a.jsx(u,{...e,children:"Hideo Kojima"})};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  args: {
    label: 'Name'
  },
...
//# sourceMappingURL=LabelledText.stories-XuBLscu5.js.map
