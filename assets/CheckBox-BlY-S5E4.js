import{a as n,F as x,j as r,u as i}from"./styled-components.browser.esm-NpdVBoMN.js";import{r as b}from"./index-BBkUAzwr.js";import{f as g}from"./focusOutline-Ba1vYvXH.js";import{T as h}from"./Text-DL1uEabl.js";import{t as e}from"./theme-D50qMPxU.js";import{u as k}from"./id-CqcUMuGv.js";const l=b.forwardRef(function({id:c,checked:d,children:p,toggle:u,error:a,errorMsg:s},m){const f=k(c);return n(x,{children:[n(y,{id:f,children:[r(h,{tag:"span",typo:"base",color:a?"strawberry":"liquorice",children:p}),r("input",{ref:m,type:"checkbox",checked:d,onChange:u}),r(o,{$error:a})]}),a&&s&&r($,{children:s})]})}),o=i.span`
  position: absolute;
  left: 0;
  width: 24px;
  height: 24px;
