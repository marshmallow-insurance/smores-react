    ...
    render === 'pound' && (
      <svg width="100%" height="100%" viewBox="0 0 16 16" fill="none">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M15 8A7 7 0 111 8a7 7 0 0114 0zm1 0A8 8 0 110 8a8 8 0 0116 0zm-5.578 3.405c.385-.397.578-.907.578-1.53L9.794 9.77c0 .289-.095.546-.284.773-.19.226-.455.34-.797.34H6.61c.65-.49.976-1.105.976-1.846 0-.111-.011-.244-.035-.398h1.87V7.616H7.212a16.818 16.818 0 01-.18-.452 4.731 4.731 0 01-.11-.399c-.04-.167-.06-.32-.06-.457 0-.338.115-.617.345-.837.232-.22.52-.33.862-.33.362 0 .653.114.872.34.222.223.337.498.344.827l1.22-.207a1.935 1.935 0 00-.328-1.097 2.116 2.116 0 00-.882-.743A2.875 2.875 0 008.055 4c-.332 0-.65.056-.952.167-.299.109-.563.261-.792.458a2.153 2.153 0 00-.544.718c-.132.286-.199.596-.199.93 0 .335.106.782.319 1.343H5.05V8.64h1.18c.04.196.06.369.06.516 0 .368-.126.712-.378 1.033-.25.322-.553.568-.912.738V12h3.932c.611 0 1.108-.198 1.49-.595z"
          fill={theme.colors[color]}
        />
      </svg>
    )}
