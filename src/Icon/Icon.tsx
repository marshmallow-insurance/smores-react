  ...
  >
...

    {
      ...
      render === 'send-message' && (
        <svg width="100%" height="100%" viewBox="0 0 32 32" fill="none">
          <path
            d="M18.201 1.25a.858.858 0 00-.17-.28.752.752 0 00-.284-.172.763.763 0 00-.235-.046h-.023a.772.772 0 00-.184.023L1.565 5.021l-.018.005A1.795 1.795 0 00.253 6.647c-.047.74.36 1.411 1.05 1.714l6.611 2.723 2.731 6.628a1.723 1.723 0 001.707 1.034 1.8 1.8 0 001.626-1.31l4.246-15.74a.745.745 0 00-.023-.446zM1.891 6.982c-.1-.045-.148-.126-.141-.24a.295.295 0 01.216-.274l13.019-3.513-6.672 6.671-6.422-2.644zm10.644 10.044a.296.296 0 01-.276.223c-.124.01-.197-.04-.233-.124l-2.652-6.438 6.671-6.672-3.51 13.011z"
            fill={theme.colors[color]}
          />
        </svg>
      )
